/**
 * Applies two operations to the input array sequentially.
 *
 * 1. Apply the operation to double values and set second to zero.
 * 2. Move non-zero values to the front of the array, and fill the remaining elements with 0.
 *
 * @param {number[]} nums - Input array of integers
 * @returns {number[]} - Modified array after operations
 */
